...
data_income <- data_income %>%
  ...
  select("TypeZelfstandige", "BedrijfstakkenBranchesSBI2008", "Perioden", "GemiddeldPersoonlijkInkomen_2", "GemiddeldInkomenAlsZelfstandige_4", "RegioS", "MediaanInkomenAlsZelfstandige_5")
