...
data_income_cleaned <- data_income %>%
  ...
  select("BedrijfstakkenBranchesSBI2008", "RegioS", "Perioden", "GemiddeldPersoonlijkInkomen_2", "GemiddeldInkomenAlsZelfstandige_4", "MediaanInkomenAlsZelfstandige_5") %>%
  group_by(Perioden, RegioS) %>%
...
data_verkoopprijs <- data_verkoopprijs %>%
  filter(startsWith(RegioS, "PV")) %>%
