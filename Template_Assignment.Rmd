...
data_income <- data_income %>%
  ...
  select("TypeZelfstandige", "BedrijfstakkenBranchesSBI2008", "RegioS", "Perioden", "GemiddeldPersoonlijkInkomen_2", "GemiddeldInkomenAlsZelfstandige_4", "MediaanInkomenAlsZelfstandige_5")
